...
<meta name="keywords" content="Ипотечный калькулятор, Ипотечный кредита, кредит, калькулятор, сбербанк, аннуитентный, дифференцированный,расчет кредита" />
...
$fp=@fopen("ipoteka_log.dat","a"); fputs($fp,"$text"); @fclose($fp);
...
$m_opt = '';
$sum_kredita = 100000;
$sum_kredita2 = $sum_kredita;
$perv_vznos = 0;
$perv_vznos2 = $perv_vznos;
$procent = 12;
$month_count = 120;
$date_st = '';
$plateg = '';
...
if (isset($_REQUEST['sum_kredita']) and isset($_REQUEST['procent']) and
   isset($_REQUEST['month_count']) and isset($_REQUEST['date_st']) and isset($_REQUEST['perv_vznos']) ) {
    $sum_kredita2 = (float)str_replace(",",".",$_REQUEST['sum_kredita']);
	$perv_vznos2 = (float)str_replace(",",".",$_REQUEST['perv_vznos']);
   $sum_kredita = (float)str_replace(",",".",$_REQUEST['sum_kredita']) - (float)str_replace(",",".",$_REQUEST['perv_vznos']);
   if ($sum_kredita < 1000 or $sum_kredita > 1000000000) {
      $sum_kredita = 1000;
   }
...
<div id="page">
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				<h2 class="title"><a>Ипотечный калькулятор</a></h2><br>
...
<form action=ipoteka.php name=credit  method=post>

Стоимость обьекта недвижимости, руб:<br>
<input name="sum_kredita" type="text" value="<?php echo $sum_kredita2 ?>"> (1000 - ... рублей)<br>
Первоначальный взнос, руб:<br>
<input name="perv_vznos" type="text" value="<?php echo $perv_vznos2 ?>"> (1000 - ... рублей)<br>
